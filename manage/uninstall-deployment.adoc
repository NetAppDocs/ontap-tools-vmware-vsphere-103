...
* To move them to an unmanaged datastore, refer to https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/migrate-a-virtual-machine-with-storage-vmotion.html[storage vMotion^]
