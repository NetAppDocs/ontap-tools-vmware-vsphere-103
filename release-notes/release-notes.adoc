...
For a complete list of new features and enhancements, refer xref:whats-new.adoc[What's new in ONTAP tools for VMware vSphere 10.3].
...
For more information, refer the https://library.netapp.com/ecm/ecm_download_file/ECMLP3334864[ONTAP tools for VMware vSphere 10.3 Release Notes^]. You must sign in with your NetApp account or create an account to access the Release Notes.