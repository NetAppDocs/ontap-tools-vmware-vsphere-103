...
---
= Migrate from ONTAP tools for VMware vSphere 9.xx to 10.3
:icons: font
:imagesdir: ../media/
...
2. link:../deploy/quick-start.html[Deploy and configure ONTAP tools for VMware vSphere 10.3] 
...
|===
[NOTE]
After migrating from ONTAP tools for VMware vSphere 9.xx to 10.3, vVols datastores using the NVMe/FC protocol become non-operational because ONTAP tools 10.3 supports the NVMe-oF protocol only with VMFS datastores.
